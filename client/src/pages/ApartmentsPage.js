            ...
            <div className={"apartments-main-box"}>
                <div className={"apartments-box"}>
                    {apartments.map((apartment) => (
                        <Link to={`/details/${apartment._id}`} className={"apartments-card-link"}>
                            <Card className={"apartments-card"}>
                                ...
                                <Card.Body>
                                    ...
                                    <Card.Text>
                                        ...
                                        <div><span
                                            className={"card-text-tl"}>Pret: {apartment.price.toLocaleString('en-US')}</span>
                                        </div>
                                    </Card.Text>
                                </Card.Body>
                            </Card>
